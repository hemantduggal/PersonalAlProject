page 50086 "SadaPriceList-SN"
{
    PageType = List;
    caption = 'Sada Price List- SN';
    UsageCategory = Administration;
    SourceTable = SadapricelistSn;
    RefreshOnActivate = true;
    //SourceTableView = where(uploadtype = filter('SN'));
    //CardPageId = "";
    ...
    actions
    {
        area(Processing)
        {
            ...
            //     trigger OnAction()
            //     begin
            //         Xmlport.Run(xmlport::importXmlportSN, false, true);
            //     end;
            // }
            ///new for Excel
            action("&Import")
    ...
    var
        SOImportBuffer: Record SadapricelistSn;
        RowNo: Integer;
        ColNo: Integer;
        LineNo: Integer;
        MaxRowNo: Integer;
