xmlport 50009 importXmlportSN
{
    ...
    schema
    {
        textelement(root)
        {
            tableelement(Sadapricelist; SadapricelistSn)
            {
                ...
                fieldattribute(Productroupcode; Sadapricelist.ProductGroupCode)
                {
                }
                ...
                begin
                    IF Heading then begin  ////skip heading of csv
                        Heading := false;
                        currxmlport.skip;
                        //Sadapricelist.uploadtype := Sadapricelist.uploadtype::SN;
                    end;
                end;
    ...
    begin
        Message('XML Uploaded Successfully For SN');
    end;
