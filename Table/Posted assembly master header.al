...
/// <summary>
/// Table POSTED ASSEMBLY MASTER HEADER (ID 50006).
/// </summary>
table 50006 "POSTED ASSEMBLY MASTER HEADER"
{
    DataClassification = ToBeClassified;
    Caption = 'POSTED ASSEMBLY MASTER HEADER TABLE';
    Description = 'This is A POSTED ASSEMBLY MASTER HEADER TABLE';
    TableType = Normal;
