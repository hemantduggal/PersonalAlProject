page 50014 "Export Sales Order"
{
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Order), "Order Type" = filter(export));
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("No."; rec."No.")
                {
                    ...
                    // var
                    //     myInt: Integer;
                    //     mgmt: Codeunit NoSeriesManagement;
                    //     SRcvblSetup: record "Sales & Receivables Setup";
                    // begin
                    //     // Rec."No." := mgmt.GetNextNo(SRcvblSetup."Export Sales Order", Today, true);
                    // end;
                }
    ...
    begin
        ...
        // DocumentIsPosted := (not Get(rec."Document Type", rec."No."));
    ...
    var
        ...
        InstructionMgt: Codeunit "Instruction Mgt.";
    begin
        // if not OrderSalesHeader.Get("Document Type", "No.") then 
        begin
    ...
    begin
        ...
        // if TestStatusIsNotReleased then
        begin
