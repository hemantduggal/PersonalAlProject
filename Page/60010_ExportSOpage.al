page 50012 "EXP Sales Order List"
{
    ApplicationArea = all;
    Caption = 'Export Sales Orders';
    CardPageID = "Export Sales Order";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), "Order Type" = filter(export));
    UsageCategory = Lists;
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Pla&nning")
                {
                    ...
                    begin
                        SalesOrderPlanningForm.SetSalesOrder("Sales Header"."No.");
                ...
                action("Order &Promising")
                {
                    ...
                    var
                        ...
                        "Sales Header": record "Sales Header";
                    begin
                        OrderPromisingLine.SetRange("Source Type", "Sales Header"."Document Type");
                        OrderPromisingLine.SetRange("Source ID", "Sales Header"."No.");
    ...
    //     CurrPage."Power BI Report FactBox".PAGE.SetCurrentListSelection(sh."No.", false, PowerBIVisible);
    // end;
